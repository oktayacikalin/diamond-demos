...
class ExampleScene(Scene):
    ...
    def setup(self):
        ...
        tilematrix.set_clipping_region(20, 50, 320, 240)

        self.transition_manager.add_change(self.move_tilematrix_left, tilematrix)
    ...
    def move_tilematrix_right(self, tilematrix):
        ...
        self.transition_manager.add_change(self.move_tilematrix_top, tilematrix)
    ...
    def move_tilematrix_left(self, tilematrix):
        ...
        self.transition_manager.add_change(self.move_tilematrix_right, tilematrix)
    ...
    def move_tilematrix_top(self, tilematrix):
        ...
        self.transition_manager.add_change(self.move_tilematrix_bottom, tilematrix)
...
def main():
    ...
    display.set_caption('TileMatrix Example 03 (clipping of matrix node)')
