...
class ExampleScene(Scene):
    ...
    def add_round(self, ticker, sprite):
        ...
        ticker.move_to(sprite, pos=(300, 300), msecs=3000)
        ticker.move_to(sprite, pos=(600, 100), msecs=3000)
        ticker.move_to(sprite, pos=(100, 300), msecs=3000)
...
def main():
    ...
    display.set_caption('Ticker Example 04')
